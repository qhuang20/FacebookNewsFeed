...
class RequestHeader: UITableViewHeaderFooterView {
    ...
    func setupViews() {
        ...
        addConstraintsWith(format: "H:|-8-[v0]-8-|", views: nameLabel)
        addConstraintsWith(format: "V:|[v0][v1(0.5)]|", views: nameLabel, bottomBorderView)
        
        addConstraintsWith(format: "H:|[v0]|", views: bottomBorderView)
    }
...
class FriendRequestCell: UITableViewCell {
    ...
    func setupViews() {
        ...
        addConstraintsWith(format: "H:|-16-[v0(52)]-8-[v1]|", views: requestImageView, nameLabel)
        
        addConstraintsWith(format: "V:|-4-[v0]-4-|", views: requestImageView)
        addConstraintsWith(format: "V:|-8-[v0]-8-[v1(24)]-8-|", views: nameLabel, confirmButton)
        
        addConstraintsWith(format: "H:|-76-[v0(80)]-8-[v1(80)]", views: confirmButton, deleteButton)
        
        addConstraintsWith(format: "V:[v0(24)]-8-|", views: deleteButton)
